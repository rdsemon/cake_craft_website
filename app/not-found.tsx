...
export const metadata = {
  ...
  description:
    "The page you&apos;re looking for doesn&apos;t exist. Return to our homepage.",
};
        ...
        <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="mb-6">
            ...
            <p className="text-base sm:text-lg text-muted-foreground max-w-md mx-auto">
              We couldn&apos;t find the delicious page you&apos;re looking for.
              It might have been moved or deleted. Let&apos;s get you back on
              track!
            </p>
          </div>
